...
let
  saccadePkg = { stdenv, fetchFromGitHub, cmake, freeimage, gflags, glog, mesa, freeglut, qtbase, qt3d, python3, mesa_glu, libglvnd, wrapQtAppsHook }: stdenv.mkDerivation rec {
    pname = "saccade";
    version = "0";
    src = fetchFromGitHub {
      owner = "PatWie";
